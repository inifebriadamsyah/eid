...
export const HeroSato = () => {
  ...
  const translateYYY = useTransform(scrollYProgress, [0, 1], [295, -650]);
  const translateYY = useTransform(scrollYProgress, [0, 1], [-15, 1230]);
      ...
      <div className="">
        ...
        <div className="relative">
          ...
          <motion.img
            ...
            width={96}
            height={96}
            className="absolute -top-[0.5rem] md:top-[53rem] -right-[4.75rem] md:right-[31.5rem] -translate-x-1/2 h-[100px] w-auto md:w-[192px] md:h-auto object-cover"
            animate={{
              rotate: "1turn",
            }}
            transition={{

...
export const ScrollRevealBottom = () => {
  ...
  const translatingX = useTransform(scrollYProgress, [0, 0.2], [200, -60]);
      ...
      <div className="">
        <div className="sticky top-0 h-screen bg-black/70 overflow-hidden flex items-start md:items-center justify-center">
          <motion.img
            ...
            alt="character"
            height={144}
            className="absolute -bottom-[3.5rem] -right-12 md:-right-8 h-[14rem] md:h-96 w-auto z-50 rounded-2xl"
            animate={{
              rotate: ["-1deg", "7deg"],
              scale: 1.05,
            }}
